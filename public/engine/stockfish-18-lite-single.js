 ...
 */ !(function () {
              ...
              return i(t, (e = new Date(e.A + 1900, e.K, e.L))) < 0
                ? a(
                    Math.ceil(
                      (31 -
                        t.getDate() +
                        (ye(M(e.getFullYear()) ? x : R, e.getMonth() - 1) - 31) +
                        e.getDate()) /
                        7,
                    ),
                    2,
              ...
              e(() => {
                if (!v && ((o = !0), a)) {
                  ...
                  var e,
                    r = !1;
                  if (
                    (O || ((e = be) && ((be = null), (n ? e.reject : e.resolve)(t), (r = !0))),
                    n && !r)
                  )
                    throw t;
                }
          ...
          var i = {
              string: function (e) {
                var n,
                  t = 0;
                return (
                  null != e && 0 !== e && ((n = 1 + (e.length << 2)), (t = P(n)), G(e, y, t, n)),
                  t
                );
              },
              array: function (e) {
  ...
  function p(e, n, t) {
    ...
    return {
      ...
      eta: r,
      etaText:
        !(n = r) || n < 0 ? "" : n < 60 ? Math.ceil(n) + " sec" : Math.round(n / 60) + " min",
    };
  }
  function d(n) {
    var r, o;
            ...
            (onmessage =
              ...
              function (e) {
                if ("setoption name CanOutputEngineDownloadProgress" === e.data)
                  ...
                  (c.processCommand ? c.processCommand(e.data) : r.push(e.data), "quit" === e.data)
                )
                  try {
                    self.close();
                  } catch (e) {}
